...
```json
{
  "functionName" : "hello",
  "gitBranch" : "main",
  "gitUrl" : "https://github.com/trisberg/my-python-func.git",
  "includeTap" : true,
  "interfaceType" : "cloudevents",
  "projectName" : "my-python-func"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ Debug NOTICE didn't match [cloudevents/func.py] -> excluded
┃ ┃ ┃ ┃ ┃ Debug README.md didn't match [cloudevents/func.py] -> excluded
┃ ┃ ┃ ┃ ┃ Debug SECURITY.md didn't match [cloudevents/func.py] -> excluded
...
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [my-python-fn->my-python-func, main->hello]
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [https://github.com/sample-accelerators/python-functions-accelerator.git->https://github.com/t...(truncated), my-python-fn->my-python-func, main->main]
...
┃ ┃ ┗ ┗ ┗ ┗  Info Will replace [my-python-fn->my-python-func]
